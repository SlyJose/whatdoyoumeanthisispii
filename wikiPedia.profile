...
#User-agent grabbed from EFX
set useragent "Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:92.0) Gecko/20100101 Firefox/92.0";
...
http-get {
    ...
    client {
        ...
        header "Host" "es.wikipedia.org";
        header "Accept" "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8";
        header "Referer" "https://es.wikipedia.org/wiki/Wikipedia:Portada";
    ...
    server {
        ...
        header "Server" "mw1442.eqiad.wmnet";
        header "X-Powered-By" "HHVM/3.12.7";
        header "X-Content-Type-Options" "nosniff";
        header "P3P" "CP=See https://es.wikipedia.org/wiki/Special:CentralAutoLogin/P3P for more info.";
...
http-post {
    ...
    client {
        ...
        output {
            base64url;
            prepend "https://es.wikipedia.org/w/index.php?search=";
